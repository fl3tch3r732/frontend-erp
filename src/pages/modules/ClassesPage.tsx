...
const ClassesPage: React.FC = () => {
  ...
  // Define all classroom categories
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex gap-2">
              ...
              >
                ...
                <option value="A">Salles A (A1-A6)</option>
                <option value="B">Salles B (B1-B6)</option>
                <option value="C">Salles C (C1-C6)</option>
                <option value="D">Salles D (D1-D6)</option>
                <option value="Audio">Salles Audio</option>
                <option value="Special">Spéciales (Labo, Amphi)</option>
              </select>
            </div>
          </div>
        </div>
              ...
              >
                <div className="flex justify-between items-start mb-4">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500">Étage {classroom.floor}</p>
                  </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="bg-white p-4 rounded-lg shadow-sm border">
            ...
            <p className="text-2xl font-bold text-blue-600">
              {classrooms.filter(c => c.hasProjector).length}
            </p>
          </div>
        </div>
      </div>
