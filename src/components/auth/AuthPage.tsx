...
import { GraduationCap, Users, Calendar, Building, BookOpen, Monitor } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <div>
                <h1 className="text-3xl font-bold text-slate-900">IUT Douala</h1>
                <p className="text-slate-600">Système de Gestion Universitaire</p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-slate-600 text-lg leading-relaxed">
                  ...
                  conçue spécialement pour les besoins de l'IUT de Douala.
                </p>
              </div>
      ...
      <footer className="bg-slate-900 text-white py-8 mt-16">
        <div className="container mx-auto px-4 text-center">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <span className="text-lg font-semibold">IUT Douala - ERP System</span>
          </div>
          <p className="text-slate-400">
            © 2024 Institut Universitaire de Technologie de Douala. Tous droits réservés.
          </p>
        </div>
      </footer>
    </div>
